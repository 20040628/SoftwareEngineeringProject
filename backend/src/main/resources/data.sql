...
-- 添加测试滑板车数据
INSERT INTO b_scooter (location, price_hour, price_day, price_week, status) 
VALUES 
('Campus Center', 5.00, 20.00, 100.00, 1),
('Library', 5.00, 20.00, 100.00, 1),
('Student Union', 5.00, 20.00, 100.00, 1);
