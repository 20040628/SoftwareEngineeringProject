	...
	<view class="keyborad" :style="{transform:show_key?'translateY(0)':'translateY(100%)'}">
		<view class="key_main">
			<view class="main_title">
				<image src="/static/icons/del_1.png" mode="aspectFill" @tap="hideFun"></image>
				<text>Enter the payment password</text>
			</view>
			<view class="main_content">
				<view class="content_num">
					<view v-for="item in inputArray" :key="item" class="content_item">{{password[item-1] ? '●' :''}}</view>
				</view>
				<!-- <view class="main_forget" @tap="forgetFun">forget the password</view> -->
			</view>
			<view class="main_keyboard">
				...
				<view class="key_del" @tap="delNumFun">
					<image src="/static/icons/del_2.png" mode="aspectFill"></image>
				</view>
			</view>
		</view>
	</view>
